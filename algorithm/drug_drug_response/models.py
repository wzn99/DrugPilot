...
from algorithm.drug_drug_response.layers import CoAttentionLayerDrugBank, CoAttentionLayerTwosides
...
class GmpnnCSNetDrugBank(nn.Module):
    ...
    def compute_score(self, pair_repr, rels):
        batch_size = len(rels)
        neg_n = (len(pair_repr) - batch_size) // batch_size  # In case of multiple negative samples per positive sample.
