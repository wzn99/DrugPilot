...
def load(config):
    ...
    # if config['dataset_type']['select_type'] =='zeroshot':      # todo
    #     data_list_train = []
    #     data_list_test = []
    ...
    dataset = DRPDataset(dataset_path = config['dataset_type']['dataset_path'])
    return dataset
...
# def create_file_in_new_folder(folder_path, file_name, content=''):
