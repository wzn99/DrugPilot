...
sys.path.append('../')
sys.path.append('/home/data1/lk/LLM/function_call/baishenglai_backend-main/algorithm/drug_synthesis_design/')
    
import rdkit
from rdkit import Chem, RDLogger 
from rdkit.Chem import rdChemReactions

from algorithm.drug_synthesis_design.scripts.utils import mkdir_p
